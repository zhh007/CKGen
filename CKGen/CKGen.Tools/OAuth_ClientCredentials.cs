...
{
    public partial class OAuth_ClientCredentials : UserControl
    {
        private OAuthTest parent;

        public OAuth_ClientCredentials(OAuthTest _parent)
        {
            InitializeComponent();
            this.parent = _parent;
        }
        ...
        private void btnGo_Click(object sender, EventArgs e)
        {
            ...
            string str = string.Format("grant_type=client_credentials");
